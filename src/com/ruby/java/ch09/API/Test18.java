...
//Pattern 클래스의 메소드 실행해보기
//login 웹으로 개발시 필수 내용 ex)암호 조건을 변경할 수 있음
//Pattern.mathches()메소드 : 특정 문자열이 패턴에 맞는지 검사
...
public class Test18 {
	public static void main(String[] args) {
        ...
        Pattern pattern = Pattern.compile(regex); //Pattern.compile() : Compiles the given regular expression into a pattern.
        Matcher matcher = pattern.matcher(password); //pattern.matcher : Creates a matcher that will match the given input against this pattern.
